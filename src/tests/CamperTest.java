...
import pages.CamperVehicleDataPage;
...
public class CamperTest extends BaseTest {
	...
	public static void main(String[] args) {
		...
		// test.
		CamperTest test = new CamperTest();
		...
		// Same for all pages:
		CamperVehicleDataPage vehicle = new CamperVehicleDataPage(test.driver);
